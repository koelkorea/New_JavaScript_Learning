...
//            -> 'this.프로퍼티명' 은 'this._프로퍼티명'에 접근하기 위한 key값으로서 존재한다고 생각하면 되겠다
...
//    ex) 만약 Tmp() 클래스 안에 isPrivate 라는 변수와 bePrivate()라는 함수가 private인데, Outside()라는 클래스에서 Tmp()의 객체를 생성하고 그 변수를 가져오고 그 함수를 실행하려고 한다면?
